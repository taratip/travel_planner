...
feature 'user views itinerary', %q(
  ...
  * I must see the itinerary's name, start date and end date
  ...
  let!(:korea) { Itinerary.create(user_id: user.id, name: "Korea", start_date: "2017-04-25", end_date: "2017-05-02") }
  ...
  scenario "user sees the itinerary's name, start date and end date" do
    sign_in user
